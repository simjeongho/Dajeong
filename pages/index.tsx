...
const landscapeData = [
	...
	<Card key="land2" src={hanRiver} alt="한강" title="한강 피크닉" year="2022" width={300} height={400} />,
	<Card key="land3" src={incheonpark} alt="인천대공원" title="인천대공원" year="2022" width={300} height={400} />,
	<Card key="land4" src={inhoo} alt="인하대 후문" title="인하대 후문" year="2022" width={300} height={400} />,
	<Card key="land5" src={daebudo} alt="첫 대부도" title="첫 대부도" year="2022" width={300} height={400} />,
	<Card key="land6" src={moouido} alt="무의도" title="무의도" year="2022" width={300} height={400} />,
];

const togetherData = [
	<Card key="together1" src={haru1} alt="하루1" title="하루필름1" year="2022" width={300} height={400} />,
	<Card key="together2" src={haru2} alt="하루2" title="하루필름2" year="2022" width={300} height={400} />,
	<Card key="together3" src={haru3} alt="하루3" title="하루필름3" year="2022" width={300} height={400} />,
	<Card key="together4" src={haru4} alt="하루4" title="하루필름4" year="2022" width={300} height={400} />,
